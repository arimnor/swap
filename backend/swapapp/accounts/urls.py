...
from .views import main_page_view,policy_view,elektrik_view,kişisel_view,signout,profile_view,calender_view,office_view,olasılık_view,tasarım_view,yazılım_view,odeme_view,unatuhenticated_view,authenticated_view,mobiluygulama_view,nesneyonelimliprg_view,temelalgoritma_view,webgelistirme_view,yazilimtest_view,activate,ictasarim_view,mimarlik_view,modatasarim_view,oyuntasarim_view,olasilikveistatistik_view,excell_view,onenote_view,outlook_view,powerpoint_view,sharepoint_view,word_view,iletisimbecerileri_view,motivasyon_view,ozguven_view,zamanyonetimi_view,elektrikproje_view,temelelektrik_view,register_instructor_view,calender_view
from . import views
